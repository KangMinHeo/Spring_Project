...
public class PaggingVO {
	...
	public int getTotalPage() {
		...
		if(count % pageOfContentCount != 0)	result++;
		return result;
	...
	public int getTotalPageGroup() {
		...
		if(getTotalPage() % pageGroupOfCount != 0) result ++;
		return result;
	}
	...
	public int getNowPageGroupNo() {
		...
		if(currentPageNo % pageGroupOfCount != 0) result ++;
		return result;
	}
	...
	public int getEndPageOfPageGroup() {
		...
		if(result>getTotalPage()) result = getTotalPage();
		return result;
	}
