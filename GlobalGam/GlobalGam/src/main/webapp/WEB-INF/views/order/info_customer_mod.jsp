...
$(document).ready(function(){
	...
	$("#myform .bot_btn > .btn_right").click(function(){
		//location.href='/obtain_order/info_customer.html';
	});
	...
	$("#myform .bot_btn > .save").click(function(){
		...
		location.href='order_info_customer_update.do?businessnum='+no+'&c_name='+name+'&user_name='+ceo+'&tel1='+tel+
	...
	$("#myform .bot_btn > .delete").click(function(){
		var no = $("input[name='businessnum']").val();
		console.log(no);
		location.href='order_info_customer_delete.do?businessnum='+no;
	});
	...
	<div class="content">
		<%@include file="../inc/left_menu.jsp"%>
			...
			<div id="content" class="infoCustomerRegCont">
				...
				<!--lnb-->
				<div class="sub_con">
					<h2 class="sub_tit">고객업체 정보 수정</h2>
					<table id="table_reg">
						<tr>
							<th>사업자 등록번호</th>
							<td>
								<input type="text" name="businessnum" value="${requestScope.dto.cuNo }">
						...
						<tr>
							...
							<td>
								<input type="text" name="c_name" value="${requestScope.dto.cuName }">
						...
						<tr>
							<th>대표자 명</th>
							<td>
								<input type="text" name="user_name" value="${requestScope.dto.cuCeo}">
						...
						<tr>
							<th rowspan="2">주소</th>
							<td><input type="text" class="trhome" id="address" placeholder="도로명 주소를 입력해주세요." name="address1" readonly value="${requestScope.add[0]}"></td>
						</tr>
						<tr>
						...
						<tr>
							<th>담당자명</th>
							<td>
								<input type="text" name="cu_manager" value="${requestScope.dto.cuEmp }">
						...
						<tr>
							...
							<input type="text" class="phonenum" maxlength="3" name='cu_ma_tel1' onkeyup="script_next_focus(this,3,document.myform.cu_ma_tel2)" value="${requestScope.em_tel[0] }">
								<span class="phonespan">-</span>
								<input type="text" class="phonenum" maxlength="4" name='cu_ma_tel2' onkeyup="script_next_focus(this,4,document.myform.cu_ma_tel3)" value="${requestScope.em_tel[1] }">
								<span class="phonespan">-</span>
								<input type="text" class="phonenum" maxlength="4" name='cu_ma_tel3' onkeyup="script_next_focus(this,4,document.myform.cu_ma_email1)" value="${requestScope.em_tel[2] }">
						...
						<tr>
							...
							<td class="email_input">
								<input class="in_em" name="cu_ma_email1" type="text" size="12" value="${requestScope.email[0] }">
								<span class="phonespan">@</span>
								<input class="in_em" name="cu_ma_email2" type="text" size="12" value="${requestScope.email[1] }">
						...
						<tr>
							<th>기타</th>
							<td><textarea class="gita" name="etc" style="resize:none;">${requestScope.dto.cuEtc }</textarea></td>
						</tr>
					</table>
					<div class="bot_box">
						<div class="bot_btn">
