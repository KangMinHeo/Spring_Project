...
$(document).ready(function(){
	...
	$("#myform .bot_btn > .btn_right").click(function(){
		...
		console.log(no+name+size+count+price+date);
 		location.href='order_info_product_insert.do?p_no='+no+'&p_name='+name+'&p_size='+size+'&p_price='+price
				...
				<div class="sub_con">
					...
					<table id="table_reg">
						<tr>
							...
							<td>
								<div class="td_wrap code_wrap">
									<input type='text' name='p_no' id='p_no' class="input_half">
								</div>
						...
						<tr>
							<th>규격</th>
							<td>
								<input type="text" id="p_size" name="p_size" style="width:100% !important;">
						...
						<tr>
							<th>표시단위</th>
							<td>
								<input type='text' name='p_count' id='p_count' class="input_half">
						...
						<tr>
							...
							<td>
								<div class="td_wrap">
									<input type="text" class="input_half" name="p_date" id="p_date">
								</div>
