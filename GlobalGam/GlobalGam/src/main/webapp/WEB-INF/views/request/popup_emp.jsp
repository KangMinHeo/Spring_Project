...
$(document).ready(function(){
	...
	$("#table_check").on("click", "tbody tr[role='row']", function(e){
		...
		$('#e_no',opener.document).val($(this).find(".e_no").text());
			...
			<table id="table_check" class="table_pop">
				...
				<tbody>
					<c:forEach var="emp" items="${requestScope.list }">
						<tr>
							<td class="e_no">${emp.eNo }</td>
							<td class="e_name">${emp.eName }</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
