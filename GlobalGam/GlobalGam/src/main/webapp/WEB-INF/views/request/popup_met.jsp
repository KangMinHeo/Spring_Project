...
$(document).ready(function(){
	...
	$("#table_check").on("click", "tbody tr[role='row']", function(e){
		var mNo = $(this).find(".m_no").text();
		console.log(mNo);
		var mName = $(this).find(".m_name").text();
		console.log(mName);
		var mPrice = $(this).find(".m_price").text();
		console.log(mPrice);
		
		/* $(opener.document).find("#e_name").val(eName);
		$(opener.document).find("#e_no").val(eNo); */
		$('.mt_number',opener.document).val($(this).find(".m_no").text());
		$('.p_name',opener.document).val($(this).find(".m_name").text());
		$('.p_price',opener.document).val($(this).find(".m_price").text());		
		$('#p_price',opener.document).text($(this).find(".m_price").text());		
