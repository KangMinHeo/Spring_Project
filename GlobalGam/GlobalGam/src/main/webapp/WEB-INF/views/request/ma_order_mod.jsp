...
$(document).ready(function() {
	...
	$(".btn.btn_right.save").click(function(){
		...
		var eNo = $("#e_no").val();
		console.log(eNo);
		var mCount = $(".quantity").val();
		console.log(mCount);
		location.href='request_ma_order_update.do?r_no='+rNo+'&e_no='+eNo+'&r_de_count='+mCount;
	});

	//삭제 버튼
	$(".btn.btn_right.delete").click(function(){
		var rNo = $("#r_no").val();
		location.href='request_ma_order_delete.do?r_no='+rNo;
	});
...
function headerFixed(){
	...
	var colArr = [0,5,9,9,9,9,9,9,9,9,9];
				...
				<div class="sub_con">
					...
					<table class="tag_table" id="due_table">
						<tbody>
							<tr>
								<th>발주번호</th>
								<td colspan="4"><input type="text" id="r_no" value="${requestScope.dto.r_no }" readonly></td>
							</tr>
							<tr>
								<th>협력업체</th>
								<td colspan="4"><input type="text" value="${requestScope.dto.co_name }" readonly></td>
							</tr>
							<tr>
								<th colspan="1">발주일자</th>
								<td colspan="2">
									<input type="text" class="btn_candle input_calendar" name="s_date" value="${requestScope.w_date[0] }" readonly>
								</td>
								<th colspan="1">납기일자</th>
								<td colspan="2">
									<input type="text" class="btn_candle input_calendar" name="e_date" value="${requestScope.e_date[0] }">
								</td>
							</tr>
							<tr target="_parent">
								<th>담당자</th>
								<td  colspan="4"  id="e_manager">
									<input type="text" id="e_no" value="${requestScope.dto.e_no }" readonly>
									<input type="text" id="e_name" value="${requestScope.dto.e_name }" readonly>
								</td>
							</tr>
							<tr>
								<th colspan="1">납품처 주소</th>
								<td colspan="5">
									<input type="text" id="ph_address" name="ph_address" style="width:60%;display:block;float:none;" readonly value="${requestScope.add[0] }">
									<input type="text" id="ph_address2" name="ph_address2" style="width:60%;float:none;" readonly value="${requestScope.add[1] }">
					...
					<table class="table_ri" id="table" style="width: 100%">
						...
						<tbody>
							<tr>
			                    ...
			                    <td>
			                    	<input type="text" class="c_name" name="c_name[]" style="cursor:pointer;" readonly value="${requestScope.dto2.r_de_m_no }">
			                    	<input type="hidden" class="pt_code" name="pt_code[]">
			                	</td>
			                    <td>
			                    	<input type="text" class="mt_number" name="mt_number[]" style="cursor:pointer;" readonly value="${requestScope.dto2.m_name }">
			                    	<input type="hidden" class="sacks_unit" name="sacks_unit[]">
			                    	<input type="hidden" class="p_unit" name="p_unit[]">
			                	</td>
			                    <td><input type="text" class="p_name" name="p_name[]" style="cursor:pointer;" readonly value="${requestScope.dto2.co_name }"></td>
			                    <td><input type="text" class="quantity" name="quantity[]" value="${requestScope.dto2.r_de_count }"></td>
			                    <td><input type="text" class="p_price" name="p_price[]" readonly value="${requestScope.dto2.m_price }"></td>
			                    
			                    <td><input type="text" class="price_sum" name="price_sum[]" readonly value="${requestScope.dto2.m_price  * requestScope.dto2.r_de_count}"></td>
			                    <td><input type="text" class="vat" name="vat[]" readonly value="${(requestScope.dto2.m_price  * requestScope.dto2.r_de_count)*0.1}"></td>
			                    <td><input type="text" class="total_sum" name="total_sum[]" readonly value="${(requestScope.dto2.m_price  * requestScope.dto2.r_de_count) + (requestScope.dto2.m_price  * requestScope.dto2.r_de_count)*0.1}"></td>
			                </tr>
						</tbody>
					</table>
					<table class="table_ri">
						...
						<tr>
							<td id="sum_qty"><input type="text" class="quantity2" value="${requestScope.dto2.r_de_count }" readonly></td>
							<td id="p_price"><input type="text" class="p_price" value="${requestScope.dto2.m_price }" readonly></td>
							<td id="sum_price"><input type="text" class="price_sum" value="${requestScope.dto2.m_price  * requestScope.dto2.r_de_count}" readonly/></td>
							<td id="sum_vat"><input type="text" class="vat" value="${(requestScope.dto2.m_price  * requestScope.dto2.r_de_count)*0.1}" readonly/></td>
							<td id="total_sum"><input type="text" class="total_sum" value="${(requestScope.dto2.m_price  * requestScope.dto2.r_de_count) + (requestScope.dto2.m_price  * requestScope.dto2.r_de_count)*0.1}" readonly/></td>
						</tr>
					</table>
					<div class="bot_box">
						<div class="bot_btn">
